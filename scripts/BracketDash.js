...
angular.module('app', ['onsen', 'ngAnimate', 'ngSanitize'])
    .controller('BracketDashController', function ($scope, $rootScope, $filter, $sce, $filechooser, Transloadit) {
        ...
        $scope.getCroppedCanvas = function () {
            alert(JSON.stringify($('#image').cropper('getCroppedCanvas').toDataUrl()));
    ...
    src = "https://bracketdash-users.s3.amazonaws.com/33/profile-picture.jpg"; // insert image url here
                ...
                //img2.src = $("#myprofilepic").attr("src");
                ...
                //$.ajax({
                //    url: "https://bracketdash-users.s3.amazonaws.com/33/profile-picture.jpg",
                //    type: 'get',
                //    crossDomain: true,
                //    success: function (data) {
                ...
                //var xhr = new XMLHttpRequest();// $scope.getxhr('GET', url);
        ...
        $scope.profilepicselected = function (data) {
            try {
                ...
                //            alert("Read complete!");
                //            $scope.cropit(Base64.encode(evt.target.result));
                //        };
                //        reader.readAsText(file);
                //    }, failFile);
                //};
                //alert(data.filepath);
                //window.resolveLocalFileSystemURI("//" + data.filepath, gotFileEntry, function (e) { alert(JSON.stringify(e)); });
